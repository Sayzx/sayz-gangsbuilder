# sayz_gangsbuilder
**sayz_gangsbuilder** is a **GangsBuilder** for FiveM developed on top of [ESX](https://github.com/ESX-Org/es_extended) and built with [NativeUI](https://github.com/FrazzIe/NativeUILua)

Ce Script est un remake de KRZ GANGS BUILDER
...
### Links & Support
- **Discord Username**: Korioz#0110 X Say#8314
...
```
ensure sayz_gangsbuilder
```
# Legal
### License
sayz_gangsbuilder - ESX GangsBuilder

Copyright (C) 2020 Say
